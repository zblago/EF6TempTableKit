    ...
    public class UtilityTest
    {
        ...
        public void TempOnTempDependenciesInQuery()
        {
            ...
            using (var context = CreateTempQueries())
            {
                ...
                Assert.DoesNotContain(_tempTableAddress.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableManufacturer.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePart.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePartType.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOffice.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableOfficeType.AddSquareBrackets(), finalQuery.ToString());
                finalQuery.Clear();

                var tempAddress = context.TempAddresses.Take(1).FirstOrDefault();
                Assert.Contains(_tempTableAddress.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableManufacturer.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePart.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePartType.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                ...
                Assert.DoesNotContain(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOffice.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOfficeType.AddSquareBrackets(), finalQuery.ToString());
                finalQuery.Clear();

                var tempManufacturer = context.TempManufacturers.Take(1).FirstOrDefault();
                Assert.Contains(_tempTableAddress.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableManufacturer.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePart.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePartType.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                ...
                Assert.DoesNotContain(_tempTableManufacturer.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePart.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTablePartType.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                ...
                Assert.Contains(_tempTableAddress.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableManufacturer.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTablePart.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTablePartType.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                ...
                Assert.Contains(_tempTablePart.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTablePartType.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOffice.AddSquareBrackets(), finalQuery.ToString());
                ...
                Assert.Contains(_tempTablePartType.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOffice.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOfficeType.AddSquareBrackets(), finalQuery.ToString());
                ...
                Assert.DoesNotContain(_tempTableChair.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOffice.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOfficeType.AddSquareBrackets(), finalQuery.ToString());
                finalQuery.Clear();
                ...
                Assert.DoesNotContain(_tempTableRoom.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOffice.AddSquareBrackets(), finalQuery.ToString());
                Assert.DoesNotContain(_tempTableOfficeType.AddSquareBrackets(), finalQuery.ToString());
                finalQuery.Clear();
                ...
                Assert.Contains(_tempTablePerson.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableDepartment.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableOffice.AddSquareBrackets(), finalQuery.ToString());
                Assert.Contains(_tempTableOfficeType.AddSquareBrackets(), finalQuery.ToString());
                finalQuery.Clear();
            }
        }
