...
using EF6TempTableKit.Test.Interceptors;
using EF6TempTableKit.Test.Web.Model.TempTables;
using System.Data.Entity;

namespace EF6TempTableKit.Test.Web.Entities.MyContext
{
    [DbConfigurationType(typeof(MyContextDbConfiguration))]
    public class MyContext : System.Data.Entity.DbContext, IDbContextWithTempTable
    {
        public MyContext()
            : base("name=MyContext")
        {
